...
<body class="flex items-center justify-center min-h-screen font-sans">
    <div class="text-center space-y-6 p-8">
        ...
        <div class="flex justify-center gap-4">
            <span class="px-4 py-2 bg-white/5 border border-white/10 rounded-full text-sm font-medium">بدو سامان بیا</span>
            <span class="px-4 py-2 bg-white/5 border border-white/10 rounded-full text-sm font-medium">فراررر</span>
        </div>
    </div>
</body>
</html>
